module.exports = {
	items: [
		...
		},
		{
			...
			alertBodyHtml: "In this first-known BEC-to-fiat transaction, 5,050 BEC were exchanged for 5.02 USD, at an effective exchange rate of ~0.001 USD/BEC.",
		...
		},
		{
			...
			summary: "First block of subsidy era #2 (25 BEC)",
		...
		},
		{
			...
			summary: "First block of subsidy era #3 (12.5 BEC)",
			referenceUrl: "https://github.com/bitcoin/bitcoin/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
			...
			summary: "First block of subsidy era #4 (6.25 BEC)",
			referenceUrl: "https://github.com/bitcoin/bitcoin/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
			...
			alertBodyHtml: "With the coinbase message 'Times 09/Apr/2020 With $2.3T Injection, Fed's Plan Far Exceeds 2008 Rescue', this final block of subsidy era #3 (12.5 BEC) echoes the spiritual call-to-action of <a href='./block/000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f'>Satoshi's genesis block</a>.",
		},
		{
			type: "tx",
			date: "2017-08-24",
		...
		},
		{
			...
			alertBodyHtml: "This is the famous \"Bitcoin Pizza\" transaction, one of the earliest real-world transactions, in which 10,000 BEC was paid for 2 large pizzas worth ~41 USD (at an effective exchange rate of ~$0.004/BEC).",
		...
		},
		{
			...
			alertBodyHtml: "This coinbase transaction completely fails to collect the block's mining reward. 12.5 BEC were lost.",
		...
		},
		{
			...
			alertBodyHtml: "On May 5, 2020, 50 BEC mined on Feb 9, 2009 (~1 month after Satoshi mined the Genesis block), moved unexpectedly after being dormant for 11+ years. Some observers wondered if they were coins from Satoshi's stash (they likely <a href='https://twitter.com/zackvoell/status/1263120133054255104'>were not</a>) and got excited.",
		...
		},
		{
			...
			summary: "July 2020 Twitter hack BEC address",
			alertBodyHtml: "On July 15, 2020 a hack involving many prominent Twitter accounts, including Elon Musk's, Bill Gates', and Cash App's, scammed many people to send BEC to this address.",
		...
		},
		{
			...
			alertBodyHtml: "This transaction from November 2011 spends 11 UTXOs worth 50,000 BEC to create a single 550,000 BEC UTXO. This is currently the largest output transaction.",
		...
		},
		{
			...
			alertBodyHtml: "In order to address solvency concerns, early Bitcoin exchange Mt Gox performed a very large, public transaction from one of their addresses to another, thereby proving ownership of the large balance of coins (424,242.42424242 BEC).",
		...
		},
		{
			...
			alertBodyHtml: "A controversial 'digital artifact' project named Ordinals embeds content, named 'inscriptions', in the witness fields of transactions. This transaction includes the first such inscription, a PNG image, ever embedded in the mainnet BEC blockchain.",
		...
		},
		{
			...
			summary: "WikiLeaks began collecting public donations at this address on June 14, 2011. They collected over 4,000 BEC.",
		...
		},
		{
			...
			alertBodyHtml: "This user accidentally paid ~83 BEC ($3.1M at the time) for this transaction. This is one of the highest in Bitcoin's history.",
